            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="py-1 text-end">
                        <a href="{{ route('service.list.product') }}" class="btn btn-primary">Go Back</a>
                    </div>
                </div>
            </div>
            <form action="{{ route('service.update.product') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-lg-8">
                        <div class="card card-body mb-1">
                                    ...
                                    <div class="mb-1 ">
                                        ...
                                        <div class="input-group ">
                                            <select class="form-control" name="brand">
                                                ...
                                                @foreach ($brand as $b)
                                                <option {{ $product->brand == $b->id ? 'selected' : '' }}
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group ">
                                        <select id="device" required class="form-control" name="device">
                                            ...
                                            @foreach ($device as $d)
                                                <option {{ $product->device == $d->id ? 'selected' : '' }}
                                    ...
                                    <div class="mb-1 ">
                                        ...
                                        <div class="input-group ">
                                            <select id="getModel" class="form-control" name="model">
                                                ...
                                                <option selected value="{{ $product->model }}">{{ $product->rel_to_model->name }}</option>
                                            </select>
                                            <a class="btn btn-info" href="{{ route('service.index.model') }}"><i
                                                    class="mdi mdi-plus"></i></a>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group ">
                                        <select required class="form-control" name="type">
                                            ...
                                            @foreach ($type as $t)
                                                <option {{ $product->type == $t->id ? 'selected' : '' }}
                            ...
                            <div class="mb-1 ">
                                ...
                                <textarea class="textArea " name="long_desp">{!! $product->long_desp !!}</textarea>
                            </div>
                            <div class="mb-1 ">
                                <label for="" class="form-label">Short Description <span class="text-danger">*</span></label>
                                <textarea class="textArea " name="short_desp">{!! $product->short_desp !!}</textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Image Alt Text"
                                        value="{{ $product->imageAlt }}" name="imageAlt">
                                ...
                                <input style="display: none;" id="altImage" type="file" class="form-control"
                                    value="{{ $product->imageAlt }}" name="image"
                                    oninput="I.src=window.URL.createObjectURL(this.files[0])">
                            </div>
                            <div class="mb-2">
                                <img width="150" id="I"
                                    src="{{ asset('/uploads/images/service/product') }}/{{ $product->image }}" alt="">
                            </div>
                        </div>
                        <div class="text-end">
                            <button style="width:100%;" type="submit" class="btn text-white btn-purple">UPDATE PRODUCT</button>
                        </div>
                    </div>
                </div>
            </form>
